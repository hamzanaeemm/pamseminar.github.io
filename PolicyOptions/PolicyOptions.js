...
async function main() {
 ...
 await updateBlackBoxes(0);
 await updateSliderValue("vocationalTraining", "vocationalTrainingValue");
 await updateSliderValue("participationRate", "participationRateValue");
 await updateStartButtonState();
 await disableControls();
 await enableControls();
 await updateBlackBoxes();
 await removeWhiteCirclesAfterSimulation();
 await updateSimulationTime();
